...
'''
    ...
    def executePet(self, video_info):
        try:
            print('msg rec.',video_info)
            mensagem = video_info
            #mensagem = json.loads(mensagem)  # Agora é um dict

            # Verifique se as chaves existem e se têm valores válidos
            video_id = video_info.get("id")
            video_path = video_info.get("video_path")  # Alterei para video_path que parece ser o valor correto
            ...
            # Se video_key é válido, continue com o processamento
