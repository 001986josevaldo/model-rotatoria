...
def lambda_function(): # index, xxx de paramentros    
    #idfileName = msg()
    idfileName = '{"id": 7,"fileName": "113.mp4", "index": 0}'
    #print(idfileName)
    idfileName = json.loads(idfileName)
    #print(idfileName)
    # Substitua a lógica de download por caminho local
    local_video_dir = "/home/josevaldo/Downloads/Vdebora"
    ...
    if idfileName["index"] == 0:
        ...
        analyzerPet.executePet(local_video_path)

    elif idfileName["index"] == 2:
        analyzerGap.executeGap(local_video_path)
